...
export default class nm_paginator extends LightningElement {
    ...
    setRecordsToDisplay(){
        ...
        let totalPagestemp =Math.ceil(this.totalRecords/this.pageSize);

        this.totalPages = (totalPagestemp==0)?1:totalPagestemp;
